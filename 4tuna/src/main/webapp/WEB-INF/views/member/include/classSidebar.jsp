...
<ul class="navbar-nav sidebar sidebar-dark accordion"
	...
	<!-- Sidebar - Brand -->
	<img src="/resources/common/image/header_logo.png" width="180px;"
		style="margin-left: 10px;" onclick="location.href='/main'">
	<!-- Divider -->
	<hr class="sidebar-divider my-0">
	<!-- Nav Item - Dashboard -->
	<li class="nav-item active">
		<div class="col-md-3 mt-4" id="classImg">
			<img src="/resources/user/image/classLogo.png" width="50" height="50"
				style="">
		</div>
	...
	<div class="d-flex justify-content-center w-100 mb-3">
		<button type="button" class="btn btn-lg mt-1" id="btn-add"
			onclick="location.href='/classInvitation'">
	...
	<li class="nav-item">
		...
		<a class="nav-link" href="/member/class/teacher/homeworklist">
		...
		<a class="nav-link" href="/zoomList">
			<i class="fa-solid fa-video" style="color: #828282;"></i>
			<span>실시간 수업</span>
		</a>
<!-- 		<a class="nav-link" href="/member/class/common/classVideoList">
		...
		<a class="nav-link" href="/classMemberList">
	...
	<li class="nav-item">
		<a class="nav-link" href="/classStorage">
	...
	<li class="nav-item">
		<c:forEach items="${categories}" var="category">
			<a class="nav-link"
				href="/member/class/common/postlist?ctboSeq=${category.ctboSeq }&ctboName=${category.ctboName}">
				<i class="fas fa-fw fa-folder" style="color: #828282;"></i>
				<span>
					<c:out value="${category.ctboName }" />
				</span>
			</a>
		</c:forEach>
	</li>
